...
\begin{table}[H]
  ...
  \begin{tabular}{|p{3.3cm}|p{4.9cm}|p{5.4cm}|}
    ...
    Acceso no autorizado a la API & Uso o abuso del servicio; acceso a los archivos cargados & Riesgo aceptado: no se implementó autenticación porque el modelo usa microdatos públicos y el prototipo no debe recibir datos personales (Capítulo~III)\\ \hline
  \end{tabular}
\end{table}
