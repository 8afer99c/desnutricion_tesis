...
\noindent\hspace*{\parindent}\textbf{Objetivo 5: validación funcional y limitaciones.} Las 5 pruebas automáticas y 15 de los 17 casos de prueba se cumplieron (fallaron el envío de un Excel a la API y la variación de la puntuación del formulario individual), y la latencia mediana fue de 29 ms en ejecución local. Estas pruebas verifican el funcionamiento del software y no la validez predictiva ni clínica. Se identificó que el nivel de riesgo puede contradecir la clase asignada, que el resumen del tablero usa predicciones sobre datos de entrenamiento, que la puntuación del formulario individual casi no varía con los datos porque el resto de las variables se imputa, y que la API no tiene autenticación.
...
\begin{itemize}
  \item \textbf{Alinear la clase y el nivel de riesgo:} usar los mismos cortes para ambos o definir el riesgo a partir del umbral de 0.42.
