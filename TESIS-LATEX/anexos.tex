...
\noindent\textbf{Notas.} En CP4, con la versión evaluada inicialmente, la clase asignada (1) y el riesgo (BAJO) no coincidían porque usaban cortes distintos; tras alinear el riesgo con el umbral de 0.42 el caso se volvió a ejecutar y devuelve riesgo MEDIO. Con el servicio corregido, los 50 registros de CP17 son consistentes: 25 con riesgo BAJO (todos clase 0), 21 MEDIO y 4 ALTO (todos clase 1). En CP9 y CP10 los ``casos'' son positivos predichos por el modelo sobre un archivo que incluye los datos de entrenamiento, no casos observados. CP14 y CP15 se agregaron al descubrir el comportamiento del servicio de archivos y del formulario; CP16 y CP17 verifican la carga de archivos del tablero corregido (Anexo~B).
