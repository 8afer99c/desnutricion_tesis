...
\begin{table}[H]
  ...
  \begin{tabular}{|p{4.0cm}|p{9.4cm}|}
    ...
    \texttt{tests/} & Pruebas de contrato de la API, de las métricas, del nivel de riesgo y del resumen del tablero\\ \hline
  \end{tabular}
\end{table}
