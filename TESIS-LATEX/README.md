...
1. (Resuelto) Se mantiene el título registrado por indicación del tutor; el trabajo se ajusta a él (Cap. I, «Relación con el tema del trabajo»). 2. Nombres de los lectores (tribunal).
